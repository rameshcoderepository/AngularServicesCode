...
export class AppComponent implements OnInit {
  ...
  // Observable used to create of Operator and it takes n number of args
  // Once all the values has been emitted it will call explicitly complete signals
  //myObservable = of(this.array1, this.array2, 20, 79, 'Hello');

  // Observable used to create from Operator and it takes only one args
  ...
  // Map  & Filter Operator using single Pipe method 
